  ...
  return (
    <BrowserRouter>
      ...
      >
        ...
        <header>
          <Navbar bg="dark" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand>Sam Shop</Navbar.Brand>
              </LinkContainer>
                  ...
                  {userInfo && userInfo.isAdmin && (
                    <NavDropdown title="Admin" id="admin-nav-dropdown">
                      ...
                      <LinkContainer to="/admin/signup">
                        <NavDropdown.Item>Admin Sign Up</NavDropdown.Item>
                      </LinkContainer>
                    </NavDropdown>
                  )}
                </Nav>
          ...
          <Nav className="flex-column text-white w-100 p-2">
            ...
            {categories.map((category) => (
              <Nav.Item key={category}>
                <LinkContainer
                  // to={`/search/category=${category}`} //salah
        ...
        <footer>
          <div className="text-center">All Right Reserved By Afiq Sam 2023</div>
        </footer>
      </div>
    </BrowserRouter>
  );
